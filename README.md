...
- [ ] Explain what a token is used for.
    A token can be used to ensure that a user is authenticated -- or using the correct credentials when trying to access certain parts of the site.

- [ ] What steps can you take in your web apps to keep your data secure?
    Only use authorized API's,
    Utilize tokens and authentication

- [ ] Describe how web servers work.
    a user types in a URL -> goes through a modem -> does a bunch of checking to see if it recognizes that URL -> find the server with that stored information and makes a request -> delivers unto the asker
